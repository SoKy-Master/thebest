            ...
            <div class="banner-wrap">
                <div id="swiper" class="swiper-container" style="height: auto;overflow: visible;">
                    <div class="swiper-wrapper swiper-wrapper1" id="swiper-wrapper">
                        <div class="swiper-slide" style="background: url(https://i.ibb.co/740WqF6/banner.png) no-repeat center;background-size: cover;"></div>
                    </div>
                </div>
                <div class="mc"></div>
                <div class="nav-box">
...
<ul>
<li cr="payment_select.os_credit_card" data-id="os_credit_card" class="list-box activeParent"><div class="list active"><!----> <img src="//midas.gtimg.cn/store_config/1591583418114fLuXpvL7.png" alt=""> <div class="bd"><p class="label">Card</p> <!----></div> <em class="icon help-icon" style="display: none;"></em> <div class="vip-bonus" style="display: none;"><p>Extra Points</p></div></div></li>
</ul>
                        </div>
						<div class="tips-box"><!----> <img src="//midas.gtimg.cn/oversea_web/static/images/creditcard/visa.png" alt="img"><img src="//midas.gtimg.cn/oversea_web/static/images/creditcard/mastercard.png" alt="img"><img src="//midas.gtimg.cn/store_config/1591840311202NFEY8rsl.jpg" alt="img"><img src="//midas.gtimg.cn/store_config/1590388413020SZ0HsR7C.png" alt="img"><img src="//midas.gtimg.cn/store_config/1590388424133LAvOXFfg.png" alt="img"><img src="//midas.gtimg.cn/store_config/15903884360138E9JgZLy.png" alt="img"><img src="//midas.gtimg.cn/store_config/1590388448535nq1ckDsi.png" alt="img"></div>
                    </div>
